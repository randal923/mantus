-- Feature 78: the imbuement scroll flow adds two audit event types. Forging a
-- scroll destroys a blank scroll plus the imbuement's astral sources and mints
-- the filled scroll; spending one imbues an item for free. Both are economy
-- events and ride the same transaction that performs them (charter rule 11).
