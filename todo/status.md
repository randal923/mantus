...
| Quests (103–105)                                         | ◐      | ◐      | Platform + rewards/log + catalog+parity gate ✅ (2026-07-26); 114 script-dir behaviors + dynamic descriptions + tracker remain; 2026-08-09 Rookgaard starter pack live (quest-lever system: bear room, katana, sewer bridge; level/premium movement gates; rapier chest; e2e `playtest:rookgaard`; goblin temple + wooden-sword chest are dead content in Canary); 2026-08-09 full quest e2e sweep (`playtest:quest-chests`, `playtest:quest-doors`) then quest-fix pass — 387/388 chests + every reachable key door verified end to end (chests resolve positionally like quest touches, charged rewards carry `charges` not counts, "impassable" doors were seeded-AI wildlife in the doorway, door sweep runs creature-free); remaining: 12 keyless doors decided per door (7+808 sealed-in-Canary, 3002 Canary-broken, 4 await NPC import), chest 6249 behind a storage-gated quest door, catalog display-only with 0 startable quests — all in `todo/quest-parity-triage.md` |
...
| Client polish: lighting, sound, hotkey persistence, modals (87) | ◐      | ◐     | Lighting shipped 2026-08-07 (day/night cycle + world-light broadcast + multiply lightmap w/ floor shading); key mapping shipped 2026-08-10 (rebindable movement/panel/interface keys, localStorage-persisted); sound, modals still open; torch-in-hand light deferred (TODO.md)                                                                                                      |
