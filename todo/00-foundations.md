...
- [x] Pin the exact map, DAT/SPR, Canary commit, OTClient commit, converter
...
- [x] Never execute downloaded Lua during an import. If bulk importing is
...
- [x] Generated content has a reproducible provenance manifest.
- [x] A machine-readable parity inventory covers every pinned gameplay/content
