...
| 3 | **Rookgaard starter quests** (rapier, goblin temple x2, wooden-sword chest, bear room, katana room, sewer bridge, level/premium bridges) | 9 registrations | B: 4 once-per-character grants (trivial chest defs). A: 5 lever/stone/door map toggles. D: 2 pushback bridges. All blocked on OTBM unique/action ids reaching the server |
