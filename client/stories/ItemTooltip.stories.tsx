...
export const Sword: Story = {
  args: { item: TIBIA_TOOLTIP_ITEMS.sword },
};

export const Axe: Story = {
  args: { item: TIBIA_TOOLTIP_ITEMS.axe },
};

export const Club: Story = {
  args: { item: TIBIA_TOOLTIP_ITEMS.club },
};

export const Bow: Story = {
  args: { item: TIBIA_TOOLTIP_ITEMS.bow },
};

export const Crossbow: Story = {
  args: { item: TIBIA_TOOLTIP_ITEMS.crossbow },
};

export const Wand: Story = {
  args: { item: TIBIA_TOOLTIP_ITEMS.wand },
};

export const Shield: Story = {
  args: { item: TIBIA_TOOLTIP_ITEMS.shield },
};

export const Helmet: Story = {
  args: { item: TIBIA_TOOLTIP_ITEMS.helmet },
};

export const Armor: Story = {
  args: { item: TIBIA_TOOLTIP_ITEMS.armor },
};

export const Legs: Story = {
  args: { item: TIBIA_TOOLTIP_ITEMS.legs },
};

export const Boots: Story = {
  args: { item: TIBIA_TOOLTIP_ITEMS.boots },
};

export const Ring: Story = {
  args: { item: TIBIA_TOOLTIP_ITEMS.ring },
};
