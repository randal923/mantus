...
- [x] **Feature 20 — Exhaustive vocation coefficient fixtures** — aggregate checks so every pinned progression coefficient is matched or explicitly non-gameplay. **Done 2026-07-24** — see [completed log](completed/implementation-feature-20-completed.md).
