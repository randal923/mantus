...
| Stamina, soul, training engines (18) → in-world triggers (72)                              | ◐      | ◐      | Beds/sleep, offline-training statue trigger, blessings persistence+purchase, food/soul regen persistence; exercise weapons/dummies ship, incl. the 5x epic/legendary store tiers with latency-proof bundled charge spends 2026-08-02 (retuned from 2x to 5x 2026-08-04) (house-membership check still missing)                     |
