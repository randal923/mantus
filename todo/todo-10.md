...
- [ ] **Feature 35 — Channels, ignore lists, talkactions, and speech modes** — Guild/party/help channels with membership enforcement, ignore lists, typed talkactions, NPC/GM/broadcast routing, and a final parity inventory. See [implementation](implementation-feature-35.md).
